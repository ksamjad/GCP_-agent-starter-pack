...
def _build_sharepoint_tool() -> FunctionTool:
  ...
  return FunctionTool.from_function(
      ...
      description=(
          "Search Microsoft SharePoint Online using the delegated permissions of the "
          "currently signed-in Microsoft 365 user. Provide the SharePoint hostname "
          "and query terms; the tool returns the most relevant documents and their URLs."
      ),
  )
