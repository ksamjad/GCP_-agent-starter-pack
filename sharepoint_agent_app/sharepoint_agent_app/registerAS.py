...
DISPLAY_NAME = "Sharepoint Agent v1.0"  # Replace with your desired display name
DESCRIPTION = "ADK agent to Search Shareppoint sites and access documents"  # Replace with your desired description
TOOL_DESCRIPTION = "The agent can access sharepoint sites and provide insights on the documents"  # Replace with your tool description
# ADK_DEPLOYMENT_ID = "6386900318029873152"  # Replace with your ADK deployment ID
ADK_DEPLOYMENT_ID = "839485923899998208"  # OAUTH TEsting
